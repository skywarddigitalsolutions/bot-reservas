  ...
  async getReservationDetails(
    ...
    try {
      ...
      const run = await this.openai.beta.threads.runs.createAndPoll(threadId, {
        ...
        instructions: `
                Devuelve la respuesta en formato JSON. La estructura es:
                {"response":"texto","name":"nombre","startDate":"YYYY-MM-DDTHH:MM","threadId":"id"}.
                Si falta el nombre, pregúntalo de manera natural. 
                Si falta la fecha, pregúntala de manera natural. 
                Mantén la conversación sin repetir preguntas ya respondidas.
            `
      });
      ...
      // ✅ Eliminar la respuesta genérica para permitir que el Assistant maneje el flujo
